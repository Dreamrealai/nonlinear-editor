...
**Score**: ___ / 6 tasks completed successfully
...
- **Feature Recognition**: ___ / 6 average
- **Satisfaction**: ___ / 5 average rating
- **Confusion Events**: ___ average per participant
