#!/usr/bin/env python3
"""
Script to replace verbose agent prompts with optimized versions in Skill.md
"""
...
# Agent 4 replacement
agent4_old = r'''Prompt: "Test advanced editing features on production
...
# Agent 5 replacement
agent5_old = r'''Prompt: "Test playback engine on production
...
content = content.replace(agent5_old, agent5_new)

# Agent 6 replacement
agent6_old = r'''Prompt: "Test state management features on production
...
content = content.replace(agent6_old, agent6_new)

# Agent 7 replacement
agent7_old = r'''Prompt: "Test AI assistant on production
...
content = content.replace(agent7_old, agent7_new)
