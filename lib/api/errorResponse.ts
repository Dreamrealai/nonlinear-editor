...
export const ErrorResponses = {
   ...
   */
  forbidden: (message: string = 'Forbidden', context?: ErrorContext): NextResponse<ErrorResponse> =>
    errorResponse(message, 403, context),

  /**
   * 404 Not Found - Resource not found
   */
  notFound: (message: string = 'Not found', context?: ErrorContext): NextResponse<ErrorResponse> =>
    errorResponse(message, 404, context),

  /**
   * 409 Conflict - Resource conflict
   */
  conflict: (message: string = 'Conflict', context?: ErrorContext): NextResponse<ErrorResponse> =>
