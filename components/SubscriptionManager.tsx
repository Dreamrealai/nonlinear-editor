          ...
          <div className="mb-5 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className={`flex h-10 w-10 items-center justify-center rounded-xl ${
                ...
                isPremium ? 'bg-gradient-to-br from-blue-500 to-blue-600' :
                'bg-neutral-200'
              }`}>
                {isAdmin ? (
            ...
            <div className="flex items-center gap-2">
              <span className={`rounded-full px-4 py-1.5 text-xs font-bold uppercase tracking-wide shadow-sm ${
                isAdmin ? 'bg-gradient-to-r from-purple-500 to-purple-600 text-white' :
              ...
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-2">
                  <div className={`h-2 w-2 rounded-full ${
                    ...
                    profile.subscription_status === 'trialing' ? 'bg-blue-500' :
                    'bg-neutral-400'
                  }`}></div>
                  <span className="text-neutral-600">Status:</span>
                  <span className="font-semibold text-neutral-900 capitalize">{profile.subscription_status}</span>
                </div>
              </div>
      ...
      <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm hover:shadow-md transition-all duration-200">
        ...
        <div className="space-y-6">
            ...
            <div className="relative h-3 w-full rounded-full bg-neutral-100 overflow-hidden shadow-inner">
              <div
                className={`h-3 rounded-full transition-all duration-500 ease-out ${
                  videoPercentage >= 90 ? 'bg-gradient-to-r from-red-500 to-red-600' :
                  videoPercentage >= 70 ? 'bg-gradient-to-r from-yellow-500 to-yellow-600' :
          ...
          <div className="group">
            ...
            <div className="relative h-3 w-full rounded-full bg-neutral-100 overflow-hidden shadow-inner">
              <div
                className={`h-3 rounded-full transition-all duration-500 ease-out ${
                  aiPercentage >= 90 ? 'bg-gradient-to-r from-red-500 to-red-600' :
                  aiPercentage >= 70 ? 'bg-gradient-to-r from-yellow-500 to-yellow-600' :
            ...
            <div className="relative h-3 w-full rounded-full bg-neutral-100 overflow-hidden shadow-inner">
              <div
                className={`h-3 rounded-full transition-all duration-500 ease-out ${
                  ...
                  storagePercentage >= 70 ? 'bg-gradient-to-r from-yellow-500 to-yellow-600' :
        ...
        <div className="mt-6 flex items-center gap-2 rounded-lg bg-neutral-50 px-4 py-3 border border-neutral-200">
          ...
          <span className="text-xs font-medium text-neutral-600">
            Usage resets on <span className="font-semibold text-neutral-900">{new Date(profile.usage_reset_at).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</span>
          </span>
        </div>
      </div>
