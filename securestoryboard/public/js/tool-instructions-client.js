// Client-side version of tool instructions
// WARNING: This is for prototype use only. Never expose API keys in production!

// API Configuration
window.DREAMREAL_CONFIG = {
...
window.DREAMREAL_CONFIG.getToolInstructions = () => {
  return `
...
window.DREAMREAL_CONFIG.getFirstCallInstruction = () => {
  const toolInstructions = window.DREAMREAL_CONFIG.getToolInstructions();
...
window.DREAMREAL_CONFIG.getRevisionInstruction = (initialPromptsText) => {
